 ...
 *
 * Disassembly of build/dsdt.aml, Mon May 25 09:59:16 2020
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x000019C6 (6598)
 *     Revision         0x02
 *     Checksum         0x5C
 *     OEM ID           "COREv4"
        ...
        Device (PCI0)
        {
            ...
            Device (PBR8)
            {
                ...
                Method (_PRT, 0, NotSerialized)  // _PRT: PCI Routing Table
                {
                    If (PMOD)
                    {
                        Return (APS8) /* \_SB_.APS8 */
                    }

                    Return (PS8) /* \_SB_.PS8_ */
                }
            }
            ...
            Device (STCR)
            {
                ...
                Device (PMRY)
                {
                    ...
                    {
                        Return (STTM) /* \_SB_.PCI0.STCR.STTM */
                    }
                ...
                Scope (\_GPE)
                {
                    Method (_L1F, 0, NotSerialized)  // _Lxx: Level-Triggered GPE, xx=0x00-0xFF
                    {
                        If (\_SB.P0PR)
                        {
                            ...
                            Notify (\_SB.PCI0.STCR.PMRY.PMST, One) // Device Check
                            \_SB.P0PR = One
                        }
                        ...
                        If (\_SB.P1PR)
                        {
                            ...
                            Notify (\_SB.PCI0.STCR.PMRY.PSLA, One) // Device Check
                            \_SB.P1PR = One
                        }
                        ...
                        If (\_SB.P2PR)
                        {
                            ...
                            Notify (\_SB.PCI0.STCR.SEDY.SMST, One) // Device Check
                            \_SB.P2PR = One
                        }
                        ...
                        If (\_SB.P3PR)
                        {
                            ...
                            Notify (\_SB.PCI0.STCR.SEDY.SSLA, One) // Device Check
                            \_SB.P3PR = One
                        }
                    }
                }
